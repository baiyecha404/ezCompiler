...
const parser = (tokens) => {
    ...
    function walk() {
        ...
        if (token.type === "parenthesis" && token.value === "(") {
            ...
            while (token.type !== "parenthesis" ||
                ...
                (_a = node.params) === null || _a === void 0 ? void 0 : _a.push(walk());
                token = tokens[curr];
            }
    ...
    while (curr < tokens.length) {
        (_a = ast.body) === null || _a === void 0 ? void 0 : _a.push(walk());
    }
    return ast;
};
const visitor = {
    ...
    CallExpression: {
        enter(node, parent) {
            ...
            (_a = parent._context) === null || _a === void 0 ? void 0 : _a.push(expression);
        }
    }
};
// traverse the ast 
const traversal = (ast, visitor) => {
    function arrayTraversal(arr, parent) {
        arr.forEach(child => {
            nodeTraversal(child, parent);
        });
    }
    function nodeTraversal(node, parent) {
        ...
        if (methods === null || methods === void 0 ? void 0 : methods.exit) {
